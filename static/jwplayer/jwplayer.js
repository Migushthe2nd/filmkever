/*!
   JW Player version 8.13.0
   Copyright (c) 2020, JW Player, All Rights Reserved
   This source code and its use and distribution is subject to the terms
   and conditions of the applicable license agreement.
   https://www.jwplayer.com/tos/
   This product includes portions of other software. For the full text of licenses, see
   https://ssl.p.jwpcdn.com/player/v/8.13.0/notice.txt
*/
window.jwplayer = function(e) {
        ...
        if (0 !== n)
            if (n) t.push(n[2]);
                ...
                a.charset = "utf-8", a.timeout = 55, i.nc && a.setAttribute("nonce", i.nc), a.src = function(e) {
                    // Replace the i.p with the cdn url
                    return "https://ssl.p.jwpcdn.com/player/v/8.13.0/" + "" + ({
                        1: "jwplayer.controls",
                        2: "jwplayer.core",
    ...
    var r = n(0),
        ...
        T = function() {
            function e(e, t, n) {
                void 0 === n && (n = null), this.code = Object(r.z)(t) ? t : 0, this.sourceError = n, e && (this.key = e)
            }
        ...
        i = function() {
            ...
            return t.on = function(e, t, n) {
                ...
                var n = this._events[e],
                    i = this._events.all;
                return n && d(n, t, this), i && d(i, arguments, this), this
                ...
                var n = this._events[e],
                    i = this._events.all;
                return n && d(n, t, this, e), i && d(i, arguments, this, e), this
            }, e
        }(),
        o = i.prototype.on,
        u = i.prototype.once,
        a = i.prototype.off,
        c = i.prototype.trigger,
        s = i.prototype.triggerSafe;
    i.on = o, i.once = u, i.off = a, i.trigger = c;
    var l = /\s+/;
    ...
    function f(e, t, n, r) {
        ...
        if (l.test(n)) {
            for (var o = n.split(l), u = 0, a = o.length; u < a; u++) e[t].apply(e, [o[u]].concat(r));
            return !1
        }
        return !0
    }
    ...
    var r = n(31),
        ...
        u = function() {
            var e = "//ssl.p.jwpcdn.com/player/v/8.13.0/";
    ...
    function h(e, t) {
        var n = e.get("plugins");
        return window.jwplayerPluginJsonp = p, (e.pluginLoader = e.pluginLoader || new o).load(t, d, n, e).then((function(t) {
    ...
    function d(e, t, n) {
        var i = e.getProviders(),
            u = e.get("preload"),
            a = Object(r.j)({}, t);
        if (a.preload = o(t.preload, u), a.allSources = h(t, e), a.sources = v(a.allSources, i), a.sources.length) return a.file = a.sources[0].file, a.feedData = n,
            function(e) {
    ...
    function h(e, t) {
        ...
        return (i || r).map((function(t) {
            ...
            m(t, n, "androidhls"), m(t, n, "hlsjsdefault"), m(t, n, "safarihlsjs"),
                function(e, t, n) {
    ...
    var r = "8.13.0+commercial_v8-13-0.384.commercial.836ed84.hlsjs.16769c8.hlsjsprogressive.37a7b5e.jwplayer.0ff989d.dai.07e1a38.freewheel.84cf03d.googima.fdb4322.headerbidding.2007d9f.vast.3062bd3.analytics.fc33a6f.gapro.141397a"
}, function(e, t, n) {
    "use strict";
    var r = n(0),
        i = n(18),
    ...
    var c, s, l = "ontouchstart" in window,
        ...
        v = function(e) {
            ...
            return i.on = function(t, n, r) {
                ...
                this.off(), f && k(this), this.el = null
            }, r
        }(o.a),
        g = /\s+/;
    ...
    function b(e) {
        if (!e.handlers.init) {
            var t = e.el,
                ...
                h = function(n) {
                    if (clearTimeout(c), e.el)
                        if (k(e), O(e, "window"), e.dragged) e.dragged = !1, x(e, i.t, n);
    ...
    function o(e, t) {
        var n = t.message,
            ...
            }(e.get("id"), n, e.get("localization").errors.errorCode, o),
            a = e.get("width"),
            c = e.get("height"),
            s = Object(r.e)(u);
        return Object(i.d)(s, {
    ...
    t.b = function(e, t) {
        ...
        var O, k, C = parseFloat(v.bandwidthEstimate),
    ...
    var r = n(3),
        ...
        a = {
            ...
            init: i,
            setState: function(e) {
                this.state = e, this.trigger(r.bb, {
                    newstate: e
                })
            },
    ...
    Object.defineProperties(l.prototype, {
        ...
        load: function() {
            var e = this,
                t = this.promise_;
            if (!t) {
                if (2 === s(this.url)) t = Promise.resolve(this);
                else {
    ...
    t.a = function() {
        ...
        function t(t) {
            try {
                var a, c = t.responseXML ? t.responseXML.childNodes : null,
                    l = "";
                if (c) {
        ...
        function n(t) {
            t.code || (t = new s.s(s.o, 0)), e.trigger(i.w, t)
        }
    ...
    function g(e) {
        var t = "file:" === window.location.protocol ? "https:" : "",
            n = {
                bidding: "//ssl.p.jwpcdn.com/player/plugins/bidding/v/0.3.4/bidding.js",
                jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.13.0/jwpsrv.js",
                dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.13/dai.js",
                vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.7.12/vast.js",
                googima: "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.7.13/googima.js",
    ...
    var b = function(e, t) {
            ...
            if (y.flashplayer = function(e) {
                    ...
                    var t = Object(r.j)({}, e.plugins),
                        n = Object(s.a)(e.edition);
                    if (n("ads")) {
                        var i = Object(r.j)({}, e.advertising),
                            o = i.client;
                        if (o) {
                            var u = g(o) || o;
                    ...
                    m(t, e.ga, "gapro");
                    var c = e.related,
                        l = !n("discovery") || c !== Object(c),
                        f = !c || "none" !== c.displayMode,
                        d = c || {},
                        p = void 0 === d.oncomplete ? "none" : d.oncomplete,
                        h = d.autoplaytimer;
                    !1 === p || e.repeat ? p = "hide" : "none" === p && (h = 0);
                    var v = "autoplay" === p && h <= 0 || "none" === p;
                    return e.related = Object(r.j)({}, c, {
                        disableRelated: l,
                        showButton: f,
                        oncomplete: p,
                        autoplaytimer: h,
    ...
    var R = function(e) {
            ...
            this.start = function(n) {
                var r = Object(j.a)(e, n),
                    i = Promise.all([Object(y.d)(e), r, _(e), F(e), L(e), N(e)]),
    ...
    var l = function() {
        function e(e, t, n) {
            ...
            Object(u.d)([f, p], Object(r.j)({
                overflow: "auto"
            }, i, c)), Object(u.d)(l, Object(r.j)({}, i, c)), this.expandElement = f, this.expandChild = d, this.contractElement = p, this.hiddenElement = l, this.element = e, this.view = t, this.model = n, this.width = 0, this.resized = !1, e.firstChild ? e.insertBefore(l, e.firstChild) : e.appendChild(l), e.addEventListener("scroll", s, !0), a.push(this), s()
        }
        return e.prototype.destroy = function() {
            if (this.view) {
                var e = a.indexOf(this); - 1 !== e && a.splice(e, 1), this.element.removeEventListener("scroll", s, !0), this.element.removeChild(this.hiddenElement), this.view = this.model = null
            }
        }, e
    }()
}, function(e, t, n) {
    ...
    function F(e) {
        ...
        i.tick("init"), e.setAttribute("data-jwplayer-id", n), Object.defineProperties(this, {
            ...
            remove: function() {
                return function(e) {
                    for (var t = v.a.length; t--;)
                        if (v.a[t].uniqueId === e.uniqueId) {
                            v.a.splice(t, 1);
                            break
                        }
                }(this), _(this, u), this
    ...
    function M(e) {
        for (var t = 0; t < v.a.length; t++)
            if (v.a[t].id === e) return v.a[t];
        return null
    }
